...
public class C2SCreateItemOrderMessage extends BaseC2SMessage {

    private final String categoryId;
    private final ItemOrderComponent orderComponent;

    public C2SCreateItemOrderMessage(PacketByteBuf buf) {
    ...
    public MessageType getType() {
        return MIFMoneyCommonNetwork.CREATE_ITEM_ORDER_COMPONENT;
    }
    ...
    public void handle(NetworkManager.PacketContext context) {
        MIFMoney.PROXY.getServerShopFile()
                ...
                .findFirst()
                .ifPresent(categoryComponent -> categoryComponent.getOrderComponents().add(orderComponent));
