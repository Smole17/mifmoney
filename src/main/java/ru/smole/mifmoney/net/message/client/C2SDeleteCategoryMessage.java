...
public class C2SDeleteCategoryMessage extends BaseC2SMessage {

    private final CategoryComponent component;

    public C2SDeleteCategoryMessage(PacketByteBuf buf) {
    ...
    public MessageType getType() {
        return MIFMoneyCommonNetwork.DELETE_CATEGORY_COMPONENT;
    }
    ...
    public void handle(NetworkManager.PacketContext context) {
        MIFMoney.PROXY.getServerShopFile().deleteCategory(component);
